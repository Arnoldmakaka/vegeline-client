...
import 'package:vege_line/screens/ui/vendor_side/vendor_info.dart';
...
class VendorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>VendorInfoWidget(vendor:vendor)));
      },
      child: Container(
                ...
                children:<Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(width:8.0,),
                      Text('${vendor.rating}', style: TextStyle(color: Colors.amber, fontWeight: FontWeight.w700),)
                    ],
                  )
                ]
              ),
